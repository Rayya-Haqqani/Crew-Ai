...
def main():
    ...
    meeting_strategy_agent = agents.meeting_analysis_agent()
    summary_and_briefing_agent = agents.summary_and_briefing_agent()

    # create tasks
    research_task = tasks.research_task(research_agent, meeting_participants, meeting_context)
    industry_analyst_task = tasks.industry_analyst_task(industry_analyst_agent, meeting_participants, meeting_context)
    ...
    meeting_strategy_task.context = [research_task, industry_analyst_task]
    summary_and_briefing_task.context = [research_task, industry_analyst_task, meeting_strategy_task]
